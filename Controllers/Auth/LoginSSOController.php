...
class LoginSSOController extends Controller
{
    ...
    var $app        = 'bappenas-komens-fordev';
    var $apikey     = 'KvPT+QsDFkeBETMpxOWLJ4GLQ8OFPWEKK78kDvDi+78+hcQ24tYYYorlDna+LVQ9Vg2la5+2hjLSN9Gt1+AqEw==';
    var $sess_id    = '';
    ...
    public function login(){
        ...
        if(empty($data->data)){
            return redirect()->to('https://akun.bappenas.go.id/bp-um/service/front/bappenas-komens-fordev/KvPT+QsDFkeBETMpxOWLJ4GLQ8OFPWEKK78kDvDi+78+hcQ24tYYYorlDna+LVQ9Vg2la5+2hjLSN9Gt1+AqEw==')->send(); 
